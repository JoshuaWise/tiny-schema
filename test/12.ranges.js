...
describe('ranges', function () {
	testRange('120-240', [120, 121, 239, 240], [119, 241, 180.1, '120', null]);
	testRange('-120-240', [-120, -119, 239, 240], [-121, 241, 1.1, '-120', null]);
	testRange('-240--120', [-120, -121, -239, -240], [-119, -241, -180.1, null]);
	testRange('120.0-240.0', [120, 121, 239, 240, 180.1], [119, 241, null]);
	testRange('-120.0-240.0', [-120, -119, 239, 240, 1.1], [-121, 241, null]);
	testRange('-240.0--120.0', [-120, -121, -239, -240, -180.1], [-119, -241, null]);
	testRange('0.1-0.11', [0.1, 0.11, 0.105], [0.09, 0.111, null]);
	testRange('-5.0--5.0', [-5], [-5.1, -4.9, null]);
	testRange('120->240', [120, 121, 239], [119, 241, 180.1, 240, null]);
	testRange('-120<-240', [-119, 239, 240], [-120, -121, 241, 1.1, null]);
	testRange('-240<->-120', [-121, -239], [-240, -120, -119, -241, -180.1, null]);
	testRange('120.0<-240.0', [120.1, 121, 239, 240, 180.1], [119, 241, 120, null]);
	testRange('-120.0->240.0', [-120, -119, 239, 239.9, 1.1], [-121, 241, 240, null]);
	testRange('-240.0<->-120.0', [-120.1, -121, -239, -239.9, -180.1], [-119, -241, -120, -240, null]);
	testRange('0.1<->0.11', [0.101, 0.109, 0.105], [0.09, 0.111, 0.1, 0.11, null]);
	testRange('-5.0->-5.0', [], [-5, -5.1, -4.9, null]);
	testRange('0-123', [-0, 0, 1, 122, 123], [-1, 124, 55.1, null]);
	testRange('-0-123', [-0, 0, 1, 122, 123], [-1, 124, 55.1, null]);
